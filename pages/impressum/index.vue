  ...
  <div>
    ...
    <main>
      <section class="w-full max-w-5xl mx-auto">
        <h1 class="title">{{ $t('impressum.title') }}</h1>
        <div class="impressum">
          <p>Angaben gemäß § 5 TMG</p>
          <br />
          <p><strong>Addresse:</strong> <br />Nick Gerretsen <br />Raunach<br />9560 Feldkirchen<br /></p>
          <br />
          <p>
          ...
          <p>
            ...
            unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und Aktualität der
            Inhalte können wir jedoch keine Gewähr übernehmen. Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für
            ...
            umgehend entfernen.<br /><br /><strong>Datenschutz</strong><br /><br />Die Nutzung unserer Webseite ist in
            der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten personenbezogene Daten
            ...
            möglich. <br />Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten durch Dritte
